...
\begin{figure}[htbp]
  ...
  \caption[Line plot of denoising of different levels of noise]{The plots show pixel values for 150 pixels on a horizontal line, as shown by the red line on the \acrlong{hq} image above, for denoising of four different levels of missing wedge noise. \acrshort{hq} corresponds to the \acrlong{hq} image, NS to the missing wedge noise image, and \acrshort{dn} to the \acrfull{dn} image. All denoising was done with TomoGAN using a loss function containing \acrshort{mse}, log-cosh, VGG, and adversarial loss components, a depth of 1, and the network was trained for $100 000$ iterations. }
...
\begin{figure}[htbp]
  ...
  \caption[Line plot of denoising of different levels of noise]{The plots show pixel values for 400 pixels on a horizontal line, as shown by the red line on the \acrshort{hq} image above, for denoising of four different levels of missing wedge noise. Figure elements are as in \cref{fig:differentnoiselineplot1}. }
...
\begin{figure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
      ...
      \caption{\acrlong{dn} \acrlong{lq} FDK. }
    \end{subfigure}
...
\begin{figure}[htbp]
  ...
  \caption[FDK]{View of the \acrshort{lq} FDK reconstruction. Figure elements are as in \cref{fig:sideplothq}.} 
...
\begin{figure}[htbp]
  ...
  \caption[Depth=1]{View of the denoised \acrshort{lq} FDK reconstruction with a depth of 1. Figure elements are as in \cref{fig:sideplothq}. }
...
\begin{figure}[htbp]
  ...
  \caption[Depth=3]{View of the denoised \acrshort{lq} FDK reconstruction with a depth of 3. Figure elements are as in \cref{fig:sideplothq}. }
...
\begin{figure}[htbp]
  ...
  \caption[Depth=5]{View of the denoised \acrshort{lq} FDK reconstruction with a depth of 5. Figure elements are as in \cref{fig:sideplothq}. }
...
\begin{figure}[htbp]
  ...
  \caption[Depth=7]{View of the denoised \acrshort{lq} FDK reconstruction with a depth of 7. Figure elements are as in \cref{fig:sideplothq}. }
...
\begin{figure}[htbp]
  ...
  \caption[Line plot]{The plot shows pixel values for 620 pixels on a horizontal line, as shown by the red line on the \acrshort{hq} image above. The denoised values are from denoising the FDK reconstruction with TomoGAN using a loss function containing \acrshort{mse}, log-cosh, VGG, and adversarial loss components, a depth of 1, and the network was trained for $100 000$ iterations. }
