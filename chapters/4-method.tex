...
\begin{figure}
    ...
    \end{subfigure}
    \caption[Different reconstructions of the IHHQ and IHLQ soda lime glass spheres dataset]{Different reconstructions of the \gls{ihhq} and the \gls{ihlq} soda lime glass spheres datasets. The three images are of the same arbitrary slice from the datasets.  }
...
The process of preparing a dataset for either training or inferrence (i.e. denoising using an already trained network) consists of a few steps. A flowchart visualizing this process is provided in \cref{fig:compilingdatasetflowchart}. The detailed steps are as follows:
